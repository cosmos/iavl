...
func scan(a interface{}, value []byte) {
	...
	case *int64:
		...
		*v = int64(binary.BigEndian.Uint64(value)) // nolint:gosec // false positive
	case *uint64:
		*v = binary.BigEndian.Uint64(value)
	case *uint32:
		*v = binary.BigEndian.Uint32(value)
	case *int32:
		*v = int32(binary.BigEndian.Uint32(value)) // nolint:gosec // false positive
	case *[]byte:
		*v = value
	case *big.Int:
...
func format(a interface{}) []byte {
	...
	case int64:
		return formatUint64(uint64(v)) // nolint:gosec // false positive
	...
	case int32:
		return formatUint32(uint32(v)) // nolint:gosec // false positive
	case []byte:
		return v
	default:
