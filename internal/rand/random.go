...
func (r *Rand) init() {
	...
	r.reset(int64(seed)) // nolint:gosec // false positive
}
...
func (r *Rand) Uint16() uint16 {
	return uint16(r.Uint32() & (1<<16 - 1)) // nolint:gosec // false positive
}
...
func (r *Rand) Uint() uint {
	...
	i := r.rand.Int()
	r.Unlock()
	return uint(i) // nolint:gosec // false positive
}

func (r *Rand) Int16() int16 {
	return int16(r.Uint32() & (1<<16 - 1)) // nolint:gosec // false positive
}

func (r *Rand) Int32() int32 {
	return int32(r.Uint32()) // nolint:gosec // false positive
}

func (r *Rand) Int64() int64 {
	return int64(r.Uint64()) // nolint:gosec // false positive
}
...
func (r *Rand) Time() time.Time {
	return time.Unix(int64(r.Uint64()), 0) // nolint:gosec // false positive
}
