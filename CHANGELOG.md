...
- [#620](https://github.com/cosmos/iavl/pull/620) Add `fastRollback` flag to rollback chain state in quick and dirty way, may leave some orphan nodes in db, not a big deal.
